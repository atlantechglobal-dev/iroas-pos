// Full list of world countries (UN member states + widely recognized territories)
// with ISO 3166-1 alpha-2 codes, so sign-up isn't limited to a handful of
// markets and each option can show its flag.
export const COUNTRIES = [
  ...
  { code: 'CG', name: 'Congo (Brazzaville)' }, { code: 'CD', name: 'Congo (DRC)' },
