...
const NAV_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: 'incoming-orders', label: 'Incoming Orders', icon: '/images/incoming.svg', badge: '12' },
      { key: 'reservations', label: 'Reservations', icon: '/images/breserve.svg' },
  ...
  },
  {
    ...
    items: [
      ...
      { key: 'notifications', label: 'Notifications', icon: '/images/noti.svg' },
